		...
		$inputs = array(
		    self::get_expand('bg', array(
			   self::get_tab(array(
			       'n' => array(
				   'options' => array(
				       self::get_color(array( ' input[type="text"]', ' textarea', ' select', ' input[type="tel"]', ' input[type="file"]' ), 'background_color_inputs', 'bg_c', 'background-color'),
				   )
			       ),
			       'h' => array(
				   'options' => array(
				         self::get_color(array( ' input[type="text"]', ' textarea', ' select', ' input[type="tel"]', ' input[type="file"]' ), 'b_c_i', 'bg_c', 'background-color','h'),
				   )
			       )
			   ))
		    )),
			...
			self::get_tab(array(
			    'n' => array(
				'options' => array(
				    self::get_font_family(array( ' input[type="text"]', ' textarea', ' select', ' input[type="tel"]', ' input[type="file"]' ),'font_family_inputs'),
				    self::get_color(array( ' input[type="text"]', ' textarea', ' select', ' input[type="tel"]', ' input[type="file"]' ), 'font_color_inputs'),
				    self::get_font_size(array( ' input[type="text"]', ' textarea', ' select', ' input[type="tel"]', ' input[type="file"]' ),'font_size_inputs'),
				    self::get_font_style(array( ' input[type="text"]', ' textarea', ' select', ' input[type="tel"]', ' input[type="file"]' ),'f_fs_i', 'f_fw_i'),
					self::get_text_shadow(array( ' input[type="text"]', ' textarea', ' select', ' input[type="tel"]', ' input[type="file"]' ),'t_sh_i'),
				)
			    ),
			    'h' => array(
				'options' => array(
				    self::get_font_family(array( ' input[type="text"]', ' textarea', ' select', ' input[type="tel"]', ' input[type="file"]' ),'f_f_i','h'),
				    self::get_color(array( ' input[type="text"]', ' textarea', ' select', ' input[type="tel"]', ' input[type="file"]' ), 'f_c_i',null,null,'h'),
				    self::get_font_size(array( ' input[type="text"]', ' textarea', ' select', ' input[type="tel"]', ' input[type="file"]' ),'f_s_i','','h'),
					self::get_font_style(array( ' input[type="text"]', ' textarea', ' select', ' input[type="tel"]', ' input[type="file"]' ),'f_fs_i', 'f_fw_i', 'h'),
					self::get_text_shadow(array( ' input[type="text"]', ' textarea', ' select', ' input[type="tel"]', ' input[type="file"]' ),'t_sh_i','h'),
				)
			    )
			))
		    )),
			...
			self::get_tab(array(
			    'n' => array(
				'options' => array(
				    self::get_font_family(array(' input[type="text"]::placeholder', ' textarea::placeholder', ' select::placeholder', ' input[type="tel"]::placeholder' ),'f_f_in_ph'),
				    self::get_color(array(' input[type="text"]::placeholder', ' textarea::placeholder', ' select::placeholder', ' input[type="tel"]::placeholder' ), 'f_c_in_ph'),
				    self::get_font_size(array(' input[type="text"]::placeholder', ' textarea::placeholder', ' select::placeholder', ' input[type="tel"]::placeholder' ),'f_s_in_ph'),
				    self::get_font_style(array(' input[type="text"]::placeholder', ' textarea::placeholder', ' select::placeholder', ' input[type="tel"]::placeholder' ),'f_fs_in_ph', 'f_fw_in_ph'),
					self::get_text_shadow(array(' input[type="text"]::placeholder', ' textarea::placeholder', ' select::placeholder', ' input[type="tel"]::placeholder' ),'t_sh_in_ph'),
				)
			    ),
			    'h' => array(
				'options' => array(
				    self::get_font_family(array( ' input[type="text"]:hover::placeholder', ' textarea:hover::placeholder', ' select:hover::placeholder', ' input[type="tel"]:hover::placeholder' ),'f_f_in_ph_h',''),
				    self::get_color(array( ' input[type="text"]:hover::placeholder', ' textarea:hover::placeholder', ' select:hover::placeholder', ' input[type="tel"]:hover::placeholder' ), 'f_c_in_ph_h',null,null,''),
				    self::get_font_size(array( ' input[type="text"]:hover::placeholder', ' textarea:hover::placeholder', ' select:hover::placeholder', ' input[type="tel"]:hover::placeholder' ),'f_s_in_ph_h','',''),
					self::get_font_style(array( ' input[type="text"]:hover::placeholder', ' textarea:hover::placeholder', ' select:hover::placeholder', ' input[type="tel"]:hover::placeholder' ),'f_fs_in_ph', 'f_fw_in_ph', 'h'),
					self::get_text_shadow(array( ' input[type="text"]:hover::placeholder', ' textarea:hover::placeholder', ' select:hover::placeholder', ' input[type="tel"]:hover::placeholder' ),'t_sh_in_ph_h',''),
				)
			    )
			))
		    )),
			...
			self::get_tab(array(
			    'n' => array(
				'options' => array(
				    self::get_border(array( ' input[type="text"]', ' textarea', ' select', ' input[type="tel"]', ' input[type="file"]' ),'border_inputs')
				)
			    ),
			    'h' => array(
				'options' => array(
				    self::get_border(array( ' input[type="text"]', ' textarea', ' select', ' input[type="tel"]', ' input[type="file"]' ),'b_i','h')
				)
			    )
			))
		    )),
			...
			self::get_tab(array(
				'n' => array(
				'options' => array(
					self::get_padding(array( ' input[type="text"]', ' textarea', ' select', ' input[type="tel"]', ' input[type="file"]' ), 'in_p')
				)
				),
				'h' => array(
				'options' => array(
					self::get_padding(array( ' input[type="text"]', ' textarea', ' select', ' input[type="tel"]', ' input[type="file"]' ), 'in_p', 'h')
				)
				)
			))
			)),
			...
			self::get_tab(array(
				'n' => array(
				'options' => array(
					self::get_margin(array( ' input[type="text"]', ' textarea', ' select', ' input[type="tel"]', ' input[type="file"]' ), 'in_m')
				)
				),
				'h' => array(
				'options' => array(
					self::get_margin(array( ' input[type="text"]', ' textarea', ' select', ' input[type="tel"]', ' input[type="file"]' ), 'in_m', 'h')
				)
				)
			))
			)),
			...
			self::get_expand('r_c', array(
				self::get_tab(array(
					'n' => array(
						'options' => array(
							self::get_border_radius(array( ' input[type="text"]', ' textarea', ' select', ' input[type="tel"]', ' input[type="file"]' ), 'in_r_c')
						)
					),
					'h' => array(
						'options' => array(
							self::get_border_radius(array( ' input[type="text"]', ' textarea', ' select', ' input[type="tel"]', ' input[type="file"]' ), 'in_r_c', 'h')
						)
					)
				))
			)),
			...
			self::get_expand('sh', array(
				self::get_tab(array(
					'n' => array(
						'options' => array(
							self::get_box_shadow(array( ' input[type="text"]', ' textarea', ' select', ' input[type="tel"]', ' input[type="file"]' ), 'in_b_sh')
						)
					),
					'h' => array(
						'options' => array(
							self::get_box_shadow(array( ' input[type="text"]', ' textarea', ' select', ' input[type="tel"]', ' input[type="file"]' ), 'in_b_sh', 'h')
						)
					)
				))
			))
