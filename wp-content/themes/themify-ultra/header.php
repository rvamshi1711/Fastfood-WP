						...
						<div class="navbar-wrapper tf_clearfix">
							...
							<?php if ($search_form!==false ){
									if ($search_form  === 'search_form') {
										...
										echo '<a data-lazy="1" class="search-button tf_search_icon tf_vmiddle tf_inline_b" href="#">'.themify_get_icon(themify_get('setting-ic-search','fas search',true),false,false,false,array('aria-label'=>__('Search','themify'))).'<span class="screen-reader-text">'.__('Search','themify').'</span></a>';
									}
							}?>

							<?php if ( themify_theme_is_dark_mode() === 'user' ) : ?>
								<a class="tf_darkmode_toggle" href="#" aria-hidden="true"><?php echo themify_get_icon( 'fas moon', 'fa' ); ?><span class="screen-reader-text"><?php _e( 'Dark mode', 'themify' ); ?></span></a>
							<?php endif; ?>
