...
if (!function_exists('themify_theme_page_meta_box')) {
	...
	return array(
		...
		'meta' => array(
		    ...
		    array('value' => 'section_scroll', 'img' => 'images/layout-icons/section-scroll.png', 'title' => __('Section Scrolling', 'themify')),
		),
		'default' => 'default',
	    ),
		array(
        ...
        array(
            'type' => 'separator',
			'meta' => [
				'html' => '<hr><strong>' . __( 'Section Scrolling Options', 'themify' ) . '</strong>',
			],
			'class' => 'tf_section_scroll_setting'
        ),
	    // Scroll Section on mobile devices
	    array(
		'name' => 'section_scrolling_mobile',
		'title' => __('Keep section scroll enabled on tablet/mobile', 'themify'),
		'type' => 'checkbox',
		'default' => 'checked',
		'shop'=>false,
		'class' => 'section-scrolling-mobile tf_section_scroll_setting'
	    ),
	    array(
			...
			'shop' => false,
			'default' => 'scroll',
			'class' => 'section-scrolling-effect tf_section_scroll_setting',
			'title' => __(' Scroll Effect', 'themify')
	    ),
		...
		'shop'=>false,
		'default' => 'vertical',
		'class' => 'section-scrolling-direction tf_section_scroll_setting',
		'title' => __('Scroll Direction', 'themify')
	    ),
		...
		'default' => 'snake',
		'shop'=>false,
		'class' => 'section-scrolling-style tf_section_scroll_setting',
		'title' => __('Scroll Style', 'themify')
	    ),
	    // Enalble parallax scrolling
	    array(
		'name' => 'section_scrolling_parallax',
		'title' => __('Disable parallax scrolling', 'themify'),
		'type' => 'checkbox',
		'default' => 'off',
		'shop'=>false,
		'class' => 'section-scrolling-parallax tf_section_scroll_setting'
	    ),
	    array(
			'name' => 'fullpage_footer_section',
			'title' => __('Append footer as last section', 'themify'),
			'type' => 'checkbox',
			'default' => 'off',
			'shop' => false,
			'class' => 'fullpage-footer tf_section_scroll_setting',
	    ),
	);
    }
...
if (!function_exists('themify_ultra_custom_post_type_layouts')) {
	...
	if (is_array($custom_posts)) {
	    foreach ($custom_posts as $key => $cPost) {
			...
			$output .= '<p>' . sprintf('<span class="label">%s %s</span>', $cPost['name'], __('Single Sidebar', 'themify'));
...
/**
 * Disable Query Portfolios feature if it's not already in use.
 *
 * @since 7.0.8
 * @return bool
 */
function themify_query_portfolio_check() {
	return themify_get( 'portfolio_query_category', '' ) !== '';
}
...
if (!function_exists('themify_theme_get_page_metaboxes')) {
	...
	if (post_type_exists('portfolio')) {
		...
		'display_callback' => 'themify_query_portfolio_check',
		'pages' => 'page'
	    );
	}
