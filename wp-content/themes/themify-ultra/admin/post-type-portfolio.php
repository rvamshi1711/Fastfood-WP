				...
				$out .= '<div data-lazy="1" class="loops-wrapper shortcode ' . esc_attr( implode(' ',$class) ) .' tf_clear">';
					...
					if ( 'slider' === $themify->post_layout ) {
						switch ( $speed ) {
							...
							$out .= '<div class="slideshow tf_swiper-container tf_carousel tf_overflow tf_rel" data-lazy="1" data-autoplay="' . esc_attr( $autoplay ) . '" data-speed="' . esc_attr( $speed ) . '" data-scroll="' . esc_attr( $scroll ) . '" data-visible="' . esc_attr( $visible ) . '"><div class="tf_swiper-wrapper tf_lazy tf_rel tf_w tf_h">';
